...
import AdvisorCard from '@/app/components/advisor-card'

const ACIVAT_MAP: Record<string, string> = {
  'adv_001': '/astriva_avatar/Happy@3x.png',
  'adv_002': '/astriva_avatar/Bad@3x.png',
  'adv_003': '/astriva_avatar/Speechless@3x.png',
  ...
  if (content.includes('David Wilson') && content.length < 500) {
    return {
      advisor: {
        ...
        title: 'Advisor',
        match_score: '98%',
        match_reason: 'Highly recommended based on keywords.',
